...
# BEGIN: change made by: Akshay Narayan (05-01-2015:1240)
from rlglue.types import Reward
# END: change made by: Akshay Narayan (05-01-2015:1240)
...
class ClientAgent:
	...
	def onAgentStep(self):
		# BEGIN: change made by: Akshay Narayan (05-01-2015:1241)
		#reward = self.network.getDouble()
		reward = self.network.getReward()
		# END: change made by: Akshay Narayan (05-01-2015:1241)
	...
	# () -> void
	def onAgentEnd(self):
		# BEGIN: change made by: Akshay Narayan (05-01-2015:1242)
		#reward = self.network.getDouble()
		reward = self.network.getReward()
		# END: change made by: Akshay Narayan (05-01-2015:1242)
